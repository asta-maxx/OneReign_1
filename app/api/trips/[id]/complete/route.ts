 ...
 * POST /api/trips/[id]/complete  → completeTrip
 *
...
import { completeTrip } from "@/lib/trip";
...
// Delegates to: completeTrip (lib/trip.ts)
export async function POST(_req: NextRequest, ctx: RouteContext) {
  ...
  try {
    ...
    console.error(`POST /api/trips/${id}/complete error`, err);
